...
The form allows users to select entities from a list for specific types, and siplay in chip.
...
interface AssignmentFormProps {
  ...
  type: string; // Type of assignment (e.g., annotator, reviewer, role)
...
const AssignmentForm: React.FC<AssignmentFormProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    } else if (type === "roleSelector") {
      data = [{
        user_id: additionalData.user_id,
        role_id: selectedEntity.id,
      }];
    }
